...
export function FinalCTA({
  ...
  return (
    <div className="rounded-3xl border border-cyan-500/35 bg-[linear-gradient(155deg,rgba(56,189,248,0.15),rgba(15,23,42,0.9))] p-8 shadow-[0_0_60px_rgba(34,211,238,0.2)] md:p-12">
      <p className="text-xs font-semibold tracking-[0.2em] text-cyan-300 uppercase">Final step</p>
      <h3 className="mt-3 text-3xl font-semibold text-white md:text-4xl">{title}</h3>
